<template>
  <div>
    <svg v-if="!isSucking" :class="{ active: isOpenSucker }" class="sucker" xmlns="http://www.w3.org/2000/svg" viewBox="-12 -12 48 48" @click="openSucker">
      <path
...
<script>
import imgSucker from "./pipette.png";
export default {
  props: {
    suckerCanvas: {
      type: null,
